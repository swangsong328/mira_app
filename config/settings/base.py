"""
Base settings for Beauty Salon project.
...
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "django-insecure-dev-key-change-this-in-production-12345678901234567890",
)
...
SITE_NAME = os.getenv("SITE_NAME", "Beauty Salon")
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@beautysalon.com")
...
# SMS Backend (extendable adapter pattern)
...
# SEO
ENABLE_SEO_OPTIMIZATIONS = os.getenv("ENABLE_SEO_OPTIMIZATIONS", "True") == "True"
